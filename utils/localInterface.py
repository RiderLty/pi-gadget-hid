...
class TouchScreen:
    ...
    def sendRaw(self,state,tid,x,y):
        write_bytes = struct.pack('<B2B2IB',1, state, tid, x, y,0)
        os.write(self.fd, write_bytes)
    
    def require(self,tid,x,y):
        self.sendRaw(1,tid,x,y)

    def move(self, tid,x,y):
        self.sendRaw(1,tid,x,y)

    def release(self, tid):
        self.sendRaw(0,tid,0,0)